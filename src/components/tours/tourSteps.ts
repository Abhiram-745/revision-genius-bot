...
export const socialTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "See how you rank among your friends and the entire Vistara community. Competition drives motivation!",
  },
  {
...
export const eventsTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Set your school hours so Vistara never schedules study sessions during school time.",
  },
  {
    target: "[data-tour='add-event']",
    content: "Add one-time or recurring events. Vistara will automatically adjust your study timetable around these events.",
  },
  {
...
export const homeworkTourSteps: Step[] = [
  {
    ...
    content: "Manage all your homework assignments in one place. Vistara schedules time for each assignment based on due dates.",
    disableBeacon: true,
  },
  {
...
export const aiInsightsTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "This heatmap shows when you're most productive. Vistara schedules harder topics during your peak hours!",
  },
  {
...
export const reflectionsTourSteps: Step[] = [
  {
    ...
    content: "Reflections help you track how each study session went. This data powers Vistara's personalized timetable adjustments.",
    disableBeacon: true,
  },
  {
