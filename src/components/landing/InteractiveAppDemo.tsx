...
import { 
  Calendar, Clock, CheckCircle2, Play, Sparkles, Timer, 
  TrendingUp, Target, RefreshCw, BookOpen, Brain, BarChart3,
  ArrowRight, Zap, Award, ChevronRight, Star, ThumbsUp
} from "lucide-react";
...
// Demo data
const demoSubjects = [
  { name: "Mathematics", topics: 12, color: "primary" },
  { name: "Biology", topics: 15, color: "secondary" },
  { name: "Physics", topics: 10, color: "accent" },
  { name: "Chemistry", topics: 14, color: "primary" },
];
...
const demoPracticeTools = [
  { name: "SaveMyExams", desc: "Past papers & marking schemes", icon: BookOpen, color: "bg-blue-500" },
  { name: "Blurt AI", desc: "Active recall practice", icon: Brain, color: "bg-purple-500" },
  { name: "Physics & Maths Tutor", desc: "Video explanations", icon: BarChart3, color: "bg-green-500" },
];
...
export const InteractiveAppDemo = () => {
  ...
  return (
    <section id="try-demo" className="py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            {/* Tab Navigation */}
            <TabsList className="w-full justify-start overflow-x-auto flex-nowrap mb-6 bg-muted/50 p-1.5 rounded-xl h-auto">
              {tabConfigs.map((tab) => {
                const Icon = tab.icon;
                return (
                  <TabsTrigger
                    key={tab.id}
                    value={tab.id}
                    className="flex-shrink-0 gap-2 px-4 py-2.5 data-[state=active]:bg-background data-[state=active]:shadow-md rounded-lg transition-all"
                  >
            ...
            <div className="grid lg:grid-cols-5 gap-6">
              {/* Demo UI - Takes 3 columns */}
              <div className="lg:col-span-3">
                <Card className="overflow-hidden border-2 border-primary/20 bg-card/80 backdrop-blur-sm min-h-[500px]">
                  <AnimatePresence mode="wait">
                      ...
                      >
                        <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              {demoSubjects.map((subject, i) => (
                                ...
                                >
                                  <Card className={`border-${subject.color}/30 bg-${subject.color}/5 hover:bg-${subject.color}/10 transition-colors cursor-pointer`}>
                          ...
                          <div className="bg-muted/50 rounded-xl p-4">
                            <p className="text-xs font-medium mb-3">Preview: Monday Schedule</p>
                            <div className="space-y-2">
                              {["06:45 - Mathematics", "15:30 - Biology", "18:15 - Physics"].map((item, i) => (
                                <motion.div
                                  ...
                                  className="flex items-center gap-2 text-sm bg-background/80 rounded-lg px-3 py-2"
                                >
                          ...
                          {demoSessions.map((session, i) => (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                                    session.status === "event" ? "bg-accent/20" : "bg-primary/20"
                                  }`}>
                                    {session.status === "event" ? (
                              ...
                              {selectedSession === i && session.status !== "event" && (
                                ...
                                >
                                  <Button size="sm" className="w-full gap-2 bg-gradient-to-r from-primary to-accent">
                        ...
                        <div className="space-y-6">
                          ...
                          <Card className="border-primary/30 bg-gradient-to-br from-primary/10 to-accent/10">
                            <CardContent className="p-6 text-center">
                              ...
                              <h4 className="text-xl font-bold mb-2">Biology - Cell Division</h4>
                              <p className="text-muted-foreground mb-4">45 minutes completed</p>
                          ...
                          {/* Daily Summary */}
                          <div className="bg-muted/50 rounded-xl p-4">
                            <p className="text-xs font-medium mb-3">Today's Progress</p>
                    ...
                    {/* Reschedule Demo */}
                    <TabsContent value="reschedule" className="m-0">
                      <motion.div
                        key="reschedule"
                        initial={{ opacity: 0, x: 20 }}
                        animate={{ opacity: 1, x: 0 }}
                      ...
                      >
                        <div className="space-y-6">
                          ...
                          <Card className="border-orange-500/30 bg-orange-500/5">
                            <CardContent className="p-4">
                              <div className="flex items-start gap-3">
                                ...
                                <div>
                                  <p className="font-medium">Missed: Physics - Newton's Laws</p>
                                  <p className="text-sm text-muted-foreground">Was scheduled for 18:15</p>
                                </div>
                              </div>
                            </CardContent>
                          </Card>
                          ...
                          <div className="text-center py-4">
                            ...
                            <p className="font-medium">AI is rescheduling...</p>
                            <p className="text-sm text-muted-foreground">Finding the best time for your missed session</p>
                          </div>
                            ...
                            <CardContent className="p-4">
                              ...
                              <div className="space-y-2">
                                <div className="flex items-center justify-between bg-background/80 rounded-lg px-3 py-2">
                                  ...
                                  <span className="text-sm font-medium text-primary">Tomorrow 06:45</span>
                                </div>
                                <div className="flex items-center justify-between bg-background/80 rounded-lg px-3 py-2">
                                  <span className="text-sm">Chemistry moved to</span>
                                  <span className="text-sm font-medium">Tomorrow 15:30</span>
                                </div>
                              </div>
                            </CardContent>
                          </Card>
                    ...
                    <TabsContent value="practice" className="m-0">
                      ...
                      >
                        <div className="space-y-6">
                          <h4 className="font-semibold">Choose Your Practice Tool</h4>
                            ...
                            {demoPracticeTools.map((tool, i) => {
                              ...
                              return (
                                <motion.div
                                  ...
                                  className="p-4 rounded-xl border-2 border-border hover:border-primary/50 cursor-pointer transition-all bg-card"
                                >
                          ...
                          {/* Recent Practice */}
                          <div className="bg-muted/50 rounded-xl p-4">
                            <p className="text-xs font-medium mb-3">Recent Practice</p>
                            <div className="space-y-2">
              ...
              <div className="lg:col-span-2">
                <Card className="h-full bg-gradient-to-br from-primary/5 via-card to-accent/5 border-primary/20">
                    ...
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mb-4">
                          <activeConfig.icon className="w-7 h-7 text-white" />
                        </div>

                        {/* Title & Description */}
                        <h3 className="text-xl font-bold mb-2">{activeConfig.title}</h3>
                        <p className="text-muted-foreground mb-6">{activeConfig.description}</p>
                        ...
                        <div className="my-6 relative h-20">
                          ...
                          <motion.div
                            className="absolute right-0 top-1/2 -translate-y-1/2 bg-primary/10 rounded-xl px-3 py-1.5"
                            initial={{ opacity: 0, x: -10 }}
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: 1.3 }}
                          >
                            <span className="text-xs font-medium text-primary">Try it live →</span>
                          </motion.div>
                        </div>
                        ...
                        <Button
                          ...
                          className="w-full gap-2 bg-gradient-to-r from-primary to-accent hover:opacity-90 shadow-lg"
                        >
                          Get Started Free
