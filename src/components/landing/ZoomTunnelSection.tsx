...
const ZoomTunnelSection = () => {
  ...
  // Text section transforms - each section gets its own scroll range
  const text1Opacity = useTransform(scrollYProgress, [0.05, 0.12, 0.18, 0.22], [0, 1, 1, 0]);
  const text1Scale = useTransform(scrollYProgress, [0.05, 0.12, 0.18, 0.22], [0.8, 1, 1, 1.1]);
  const text1Y = useTransform(scrollYProgress, [0.05, 0.12, 0.18, 0.22], [30, 0, 0, -30]);

  const text2Opacity = useTransform(scrollYProgress, [0.2, 0.27, 0.33, 0.37], [0, 1, 1, 0]);
  const text2Scale = useTransform(scrollYProgress, [0.2, 0.27, 0.33, 0.37], [0.8, 1, 1, 1.1]);
  const text2Y = useTransform(scrollYProgress, [0.2, 0.27, 0.33, 0.37], [30, 0, 0, -30]);

  const text3Opacity = useTransform(scrollYProgress, [0.35, 0.42, 0.48, 0.52], [0, 1, 1, 0]);
  const text3Scale = useTransform(scrollYProgress, [0.35, 0.42, 0.48, 0.52], [0.8, 1, 1, 1.1]);
  const text3Y = useTransform(scrollYProgress, [0.35, 0.42, 0.48, 0.52], [30, 0, 0, -30]);

  const text4Opacity = useTransform(scrollYProgress, [0.5, 0.57, 0.63, 0.67], [0, 1, 1, 0]);
  const text4Scale = useTransform(scrollYProgress, [0.5, 0.57, 0.63, 0.67], [0.8, 1, 1, 1.1]);
  const text4Y = useTransform(scrollYProgress, [0.5, 0.57, 0.63, 0.67], [30, 0, 0, -30]);

  const text5Opacity = useTransform(scrollYProgress, [0.65, 0.75, 0.9, 0.98], [0, 1, 1, 0]);
  const text5Scale = useTransform(scrollYProgress, [0.65, 0.75, 0.85], [0.8, 1, 1]);
  const text5Y = useTransform(scrollYProgress, [0.65, 0.75], [30, 0]);
  ...
  // Frame transforms - 10 frames staggered across scroll with dramatic zoom
  const frame1Scale = useTransform(scrollYProgress, [0, 0.35], [0.05, 10]);
  const frame2Scale = useTransform(scrollYProgress, [0.03, 0.38], [0.05, 10]);
  const frame3Scale = useTransform(scrollYProgress, [0.06, 0.41], [0.05, 10]);
  const frame4Scale = useTransform(scrollYProgress, [0.09, 0.44], [0.05, 10]);
  const frame5Scale = useTransform(scrollYProgress, [0.12, 0.47], [0.05, 10]);
  const frame6Scale = useTransform(scrollYProgress, [0.15, 0.50], [0.05, 10]);
  const frame7Scale = useTransform(scrollYProgress, [0.18, 0.53], [0.05, 10]);
  const frame8Scale = useTransform(scrollYProgress, [0.21, 0.56], [0.05, 10]);
  const frame9Scale = useTransform(scrollYProgress, [0.24, 0.59], [0.05, 10]);
  const frame10Scale = useTransform(scrollYProgress, [0.27, 0.62], [0.05, 10]);

  const frame1Opacity = useTransform(scrollYProgress, [0, 0.2, 0.35], [1, 0.8, 0]);
  const frame2Opacity = useTransform(scrollYProgress, [0.03, 0.23, 0.38], [1, 0.8, 0]);
  const frame3Opacity = useTransform(scrollYProgress, [0.06, 0.26, 0.41], [1, 0.8, 0]);
  const frame4Opacity = useTransform(scrollYProgress, [0.09, 0.29, 0.44], [1, 0.8, 0]);
  const frame5Opacity = useTransform(scrollYProgress, [0.12, 0.32, 0.47], [1, 0.8, 0]);
  const frame6Opacity = useTransform(scrollYProgress, [0.15, 0.35, 0.50], [1, 0.8, 0]);
  const frame7Opacity = useTransform(scrollYProgress, [0.18, 0.38, 0.53], [1, 0.8, 0]);
  const frame8Opacity = useTransform(scrollYProgress, [0.21, 0.41, 0.56], [1, 0.8, 0]);
  const frame9Opacity = useTransform(scrollYProgress, [0.24, 0.44, 0.59], [1, 0.8, 0]);
  const frame10Opacity = useTransform(scrollYProgress, [0.27, 0.47, 0.62], [1, 0.8, 0]);

  // Rotation for extra visual impact
  const frame1Rotation = useTransform(scrollYProgress, [0, 0.35], [0, 20]);
  const frame2Rotation = useTransform(scrollYProgress, [0.03, 0.38], [0, -15]);
  const frame3Rotation = useTransform(scrollYProgress, [0.06, 0.41], [0, 25]);
  const frame4Rotation = useTransform(scrollYProgress, [0.09, 0.44], [0, -20]);
  const frame5Rotation = useTransform(scrollYProgress, [0.12, 0.47], [0, 15]);
  const frame6Rotation = useTransform(scrollYProgress, [0.15, 0.50], [0, -25]);
  const frame7Rotation = useTransform(scrollYProgress, [0.18, 0.53], [0, 20]);
  const frame8Rotation = useTransform(scrollYProgress, [0.21, 0.56], [0, -15]);
  const frame9Rotation = useTransform(scrollYProgress, [0.24, 0.59], [0, 25]);
  const frame10Rotation = useTransform(scrollYProgress, [0.27, 0.62], [0, -20]);
  ...
  const lineOpacity = useTransform(scrollYProgress, [0, 0.3, 0.7, 1], [0.1, 0.4, 0.4, 0.1]);
