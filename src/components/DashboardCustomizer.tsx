...
export const DEFAULT_SECTIONS: DashboardSection[] = [
  { id: "progress", label: "Progress Tracking", description: "Study streak, leaderboards, and goals", enabled: true, order: 0, x: 0, y: 0, w: 12, h: 5, minW: 4, minH: 3 },
  { id: "events", label: "Events & Commitments", description: "Your schedule at a glance", enabled: true, order: 1, x: 0, y: 5, w: 6, h: 4, minW: 3, minH: 2 },
  { id: "analytics", label: "AI Analytics", description: "Insights and performance analysis", enabled: true, order: 2, x: 6, y: 5, w: 6, h: 4, minW: 3, minH: 2 },
  { id: "timetables", label: "Timetables", description: "Your study plans", enabled: true, order: 3, x: 0, y: 9, w: 8, h: 4, minW: 4, minH: 3 },
  { id: "homework", label: "Active Homework", description: "Homework tracker", enabled: true, order: 4, x: 8, y: 9, w: 4, h: 4, minW: 3, minH: 2 },
];
