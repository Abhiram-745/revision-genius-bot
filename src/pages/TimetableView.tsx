...
const TimetableView = () => {
  ...
  // Trigger tour after timetable data loads
  useEffect(() => {
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 space-y-4">
          ...
          <div className="space-y-2" data-tour="timetable-progress">
            <div className="flex items-center justify-between">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div
                          ...
                          className={`p-4 rounded-xl border-l-4 transition-all duration-300 ${
                            session.completed
                              ...
                              : "bg-gradient-to-r from-primary/5 to-primary/10 border-primary backdrop-blur-sm"
                          } ${
          ...
          <div className="lg:w-96 space-y-6">
            <div className="lg:sticky lg:top-24 space-y-6">
              <Card data-tour="timetable-calendar">
                <CardHeader>
