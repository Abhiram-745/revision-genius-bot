...
const Homework = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 md:py-8 max-w-6xl relative z-10" data-tour="homework-page">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => navigate("/")}
        ...
        <div className="mb-4 md:mb-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold gradient-text mb-2 md:mb-3">Homework & Assignments</h1>
