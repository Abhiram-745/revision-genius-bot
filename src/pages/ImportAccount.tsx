...
export default function ImportAccount() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      ...
      toast({
        title: "Invalid File",
        description: "The selected file is not a valid Vistara export.",
        variant: "destructive",
      });
      }
    };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Upload a Vistara export file to restore your data
          </p>
        </div>
        ...
        {!importData && !report && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select the JSON file you exported from another Vistara account
              </CardDescription>
            </CardHeader>
            <CardContent>
