...
const LogoGenerator = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = 'vistara-logo-enhanced.png';
      a.click();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-background">
      <Card className="w-full max-w-2xl glass-card">
        <CardHeader>
          <CardTitle className="gradient-text">Vistara Logo Generator</CardTitle>
          <CardDescription>Generate an enhanced AI-powered logo for Vistara</CardDescription>
        </CardHeader>
          ...
          {logoUrl && (
            <div className="space-y-4 animate-fade-in">
              ...
              <p className="text-xs text-muted-foreground text-center">
                Save this logo to src/assets/vistara-logo.png to use it in the app
              </p>
            </div>
          )}
        </CardContent>
