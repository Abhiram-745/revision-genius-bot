          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Vistara creates personalized study timetables that actually fit your life—around homework, football practice, family dinners, and those days you just need a break.
              </p>
            </div>
