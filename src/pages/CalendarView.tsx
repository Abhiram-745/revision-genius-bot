...
import { ArrowLeft, ChevronLeft, ChevronRight, Clock, BookOpen, CheckCircle2, Calendar, Coffee, FileText, AlertCircle } from "lucide-react";
...
const getItemStyles = (item: CalendarItem) => {
  ...
  // Homework sessions stay purple  
  if (sessionType === "homework") {
    return { bg: "bg-purple-500", text: "text-white", icon: <FileText className="h-3 w-3" /> };
  }
  
  // ALL study sessions (revision, practice, exam_questions, study) use primary teal color
  return { bg: "bg-primary", text: "text-primary-foreground", icon: <BookOpen className="h-3 w-3" /> };
};
