# Vistara - GCSE Study Planning Application

## Overview
Vistara is a GCSE revision planner that creates personalized study timetables that fit around student schedules. Built with React frontend and Express backend, using Neon Postgres database with Drizzle ORM.
